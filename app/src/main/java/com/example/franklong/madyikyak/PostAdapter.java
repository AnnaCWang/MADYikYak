...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.ViewHolder> {
    ...
    public static class Vie wHolder extends RecyclerView.ViewHolder {
    ...
    public PostAdapter(ArrayList<String> myDataset, ArrayList<String> myUsername, ArrayList<String> myTimeStamp, ArrayList<String> myURL, Context myContext) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Picasso.with(context).load(mURL.get(position)).into(holder.profilePicture); //loads all images
